...
<body>
    ...
    <nav class="navbar navbar-expand-sm bg-light navbar-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">SAMUDRA BANK <img src="logos/lugu.jpeg" alt="Bank" width="50" height="50"></a>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="background/2_2.jpg" width="1000" height="585" class="d-block w-100" alt="...">

            </div>
            <div class="carousel-item">
                <img src="background/2_4.jpeg" width="1000" height="585" class="d-block w-100" alt="...">
